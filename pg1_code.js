...
ques1  = documenques2  = document.querySelectorAll('input[name =  "question2"]');
...
t.querySelectorAll('input[name =  "question1"]');
...
function execute()
{
    ...
    document.getElementById("temp").innerHTML = ieScore;
}
